...
class staticEncoderBase_Vector(nn.Module):
    '''
    in_channels: 
    h_channels: 
    out_channels: 
    ...
    def __init__(self, in_channels, h_channels, out_channels, conv_kernels,
        ...
        self.out_layer_norm = nn.LayerNorm(h_channels)
        self.mu_logs_linear = nn.Linear(h_channels, self.out_channels)
...
class staticEncoderJAVE(nn.Module):
    '''
    in_channels: 
    h_channels: 
    out_channels: 

...
def main(configs, file_config, experi_name):
    ...
    trn_set = finchbird2(dataset_config, subset='train') # 'train'
    val_set = finchbird2(dataset_config, subset='val')
...
if __name__ == "__main__":
    ...
    # config file name
    dataset_pathname = "dataset_finch_bird2_chunk.yaml"
    model_pathname = "model_finch_bird2.yaml"
    train_pathname = "train_finch_bird10.yaml" 
    
    # config path
    data_config_path  = "./Animal/configs/finch_bird2/" + "/" + dataset_pathname
    model_config_path = "./Animal/configs/finch_bird2/" + "/" + model_pathname
    train_config_path = "./Animal/configs/finch_bird2/" + "/" + train_pathname
    ...
    # run
    experi_name = 'finch_bird2/finch_bird2_10'

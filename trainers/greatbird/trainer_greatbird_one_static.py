...
def main(configs, file_config, experi_name):
    ...
    while True:
        for mel, lenx, indi_mel, cID, cID_type in tqdm(trn_loader):
            ...
            # total loss function
            loss = (nll + indi_gamma * (indi_kl - indi_c).abs())
            ...
            if global_step > 0 and global_step % val_step == 0:
                ...
                with torch.no_grad():
                    ...
                    gr_mel_fig = plot_mel(val_indi_mel)
...
if __name__ == "__main__":
    ...
    model_pathname = "model_greatbird_one_static.yaml"
    train_pathname = "train_greatbird_one_static_8.yaml" 
    ...
    # run
    experi_name = 'greatbird/greatbird_one_static_8'

    ...
    while True:
        for mel, lenx, indi_mel, cID, cID_type in tqdm(trn_loader):
            ...
            if global_step > 0 and global_step % log_step == 0:
                ...
                message2 = "  NLL: {:.3f}, con-kl: {:.3f}, loss: {:.3f}".format(*losses)
                message3 = "  gamma_con: {:.3f}".format((con_gamma * (con_kl - con_c).abs()).item())
            ...
            if global_step > 0 and global_step % val_step == 0:
                ...
                message2 = "  gamma_con: {:.3f}".format(con_gamma * np.abs((val_con_kl - con_c)))
...
if __name__ == "__main__":
    ...
    model_pathname = "model_greatbird_one_8.yaml"
    train_pathname = "train_greatbird_one_1.yaml" 
    ...
    # run
    experi_name = 'greatbird/greatbird_one_9'
